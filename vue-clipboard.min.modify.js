(function e(t, n, r) {
    ...
    }, {"./vue-clipboard.js": 10}], 2: [function (require, module, exports) {
        (function (global, factory) {
            ...
            var ClipboardAction = function () {
                ...
                _createClass(ClipboardAction, [{
                    ...
                    key: "handleResult", value: function handleResult(succeeded) {
                    ...
                    key: "target", set: function set(target) {
                        if (target !== undefined) {
        ...
        (function (global, factory) {
            ...
            var Clipboard = function (_Emitter) {
                ...
                _createClass(Clipboard, [{
                    ...
                    key: "listenClick", value: function listenClick(trigger) {
                        var _this2 = this;
                    ...
                    key: "defaultAction", value: function defaultAction(trigger) {
                        return getAttributeValue("action", trigger)
                    }
                }, {
                    key: "defaultTarget", value: function defaultTarget(trigger) {
                    ...
                    key: "defaultText", value: function defaultText(trigger) {
                        ...
                        if(binding.arg  === "fn"){
							...
							var clipboard = new Clipboard(el, {
                                text: function () {
                                    ...
                                    if(el.fn != null){
										//调用扩展方法来返回剪贴析的字符
                                        value = el.fn(el.getAttribute("params"));
                                    }
                                    return value;
                                }, action: function () {
